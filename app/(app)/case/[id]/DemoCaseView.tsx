...
const cardClass = "border-border-soft bg-surface-elevated/25 backdrop-blur-xl";
                  ...
                  <>
                    ...
                    <div className="space-y-3">
                      ...
                      {redirectData.map(
                        (r) =>
                          r.data && (
                            <div key={r.id} className="rounded-md border border-border-soft bg-surface-elevated/60 p-3">
                      ...
                      {networkData.map(
                        (n) =>
                          n.data && (
                            <div key={n.id} className="rounded-md border border-border-soft bg-surface-elevated/60 p-3">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                      <div className="space-y-3">
                        ...
                        {policy.length === 0 ? (
                          ...
                          policy.map((item, i) => (
                            <div key={i} className="rounded-md border border-border-soft bg-surface-elevated/60 p-3 text-sm">
            ...
            <Card className={cardClass}>
              ...
              <CardContent>
                <ul className="space-y-3">
                  {c.ruleRuns.map((run) => (
                    <li key={run.id} className="rounded-md border border-border-soft bg-surface-elevated/60 p-3 text-sm">
                      <div className="flex flex-wrap items-center gap-2">
                        ...
                        <Badge variant={severityVariant(run.rule.severity)}>{run.rule.severity}</Badge>
                ...
                {latestLlm ? (
                  <>
                    ...
                    {Array.isArray(advisory?.claims) && advisory.claims.length > 0 && (
                      <details className="rounded border border-border-soft bg-surface-elevated/60">
          ...
          <div className="space-y-6">
            ...
            {c.caseFiles.length > 0 && (
              <Card className={cardClass}>
                ...
                <CardContent>
                  <pre className="overflow-auto rounded bg-surface-elevated/60 p-3 text-xs text-text-muted">
